...
public class MessageConfig {
    ...
    /**
     * @param messages
     * the enum that implements Messages
     * @param file
     * the file to save the messages to
     */
    public MessageConfig(Class<? extends Messages> messages, File file) {
    ...
    public void load() {
        if (config != null) {
            ...
            for (String key : keySet) {
                ...
                try {
                    message = (Messages) messages.getDeclaredMethod("getByIdentifier", String.class).invoke(null, key);
                } catch (NoSuchMethodException | SecurityException | IllegalAccessException | IllegalArgumentException | InvocationTargetException exception) {
    ...
    /**
     * @param message
     * the matching enum value from the Messages implementation
     * @param args
