 ...
 */
package io.github.dre2n.commons.worldloader;
...
public class v1_12_R1 extends InternalsProvider {
    ...
    World createWorld(WorldCreator creator) {
        ...
        Convertable converter = new WorldLoaderServer(worldContainer, server.getHandle().getServer().dataConverterManager);
        ...
        IDataManager sdm = new ServerNBTManager(worldContainer, name, true, server.getHandle().getServer().dataConverterManager);
